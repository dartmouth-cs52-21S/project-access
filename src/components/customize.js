...
function customize(props) {
  ...
  const [rodalStatus, setRodalStatus] = useState(false);
  ...
  function changeRodal() {
    console.log('Activated');
    if (rodalStatus) {
      setRodalStatus(false);
    } else {
      setRodalStatus(true);
    }
  }
    ...
    if (currentSlide == 1) {
      return (
        <div className="custom_section">
          ...
          <button type="button" onClick={changeRodal}>Click Me</button>
          <Rodal visible={rodalStatus} width={20} height={20}> <p>flexDirection: {portfolio.header?.userName.flexDirection} </p></Rodal>
          ...
          <Rodal type="button" className="giveUserflexOptions"> <p>flexDirection: {portfolio.header?.role.flexDirection} </p></Rodal>
    ...
    if (currentSlide == 2) {
      return (
        <div className="custom_section">
          ...
          <Rodal type="button" className="giveUserflexOptions"><p>flexDirection: {portfolio.aboutMe?.flexDirection} </p></Rodal>
    ...
    if (currentSlide == 3) {
      return (
        <div className="custom_section">
          ...
          <Rodal>flexDirection: {portfolio.projects?.flexDirection}</Rodal>
